...
import {enablePrepareI18nBlockForHydrationImpl, enableTrySerializeI18nBlockImpl, setIsI18nHydrationSupportEnabled} from './i18n';
...
function enableI18nHydrationRuntimeSupport() {
  if (!isI18nHydrationRuntimeSupportEnabled) {
    ...
    enableTrySerializeI18nBlockImpl();
...
export function withDomHydration(): EnvironmentProviders {
  return makeEnvironmentProviders([
    ...
    },
    {
      ...
      useValue: () => {
        setIsI18nHydrationSupportEnabled(!!inject(IS_I18N_HYDRATION_ENABLED, {optional: true}));
